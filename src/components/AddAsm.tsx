...
import { ScrollView, SafeAreaView, StatusBar, View, Text, Dimensions, Image, TouchableWithoutFeedback, TouchableOpacity, TouchableHighlight, RefreshControl, ActivityIndicator } from 'react-native'
...
const AddAsm = ({ closeModal }: { closeModal: () => void }) => {
  ...
  const [statusDrpDownOpen, setStatusDrpDownOpen] = useState(false);
    ...
    >
            ...
            >
              <Text>
                {date.toLocaleTimeString().localeCompare(
                  ...
                  'en-US',
                  { hour: 'numeric', minute: 'numeric', hour12: false, timeZone: 'Asia/Hong_Kong' }
                )}
              </Text>
            </TouchableOpacity>
        ...
        >
          ...
          >
            <DropDownPicker
              ...
              open={statusDrpDownOpen}
              setOpen={setStatusDrpDownOpen}
      ...
      <TouchableOpacity
        style={{
          ...
          opacity: (!title || !selectedCourse || !selectedStatus) ? 0.5 : 1,
          justifyContent: 'center',
          alignItems: 'center',
          flexDirection: 'row',
          gap: 10,
        ...
        disabled={!title || !selectedCourse || !selectedStatus }
